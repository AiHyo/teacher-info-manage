...
public class WorkExperienceAuditController {
    ...
    @GetMapping("/query/{id}")
    public R<WorkExperienceDto> queryById(@PathVariable("id") Long id) {
...
//        this.makeFilesUsefulByID(id);
    ...
    public R<Page<WorkExperienceDto>> queryOwnRecord(@RequestParam(value = "auditStatus",required = false) Integer auditStatus,
    ...
    public R<Page<WorkExperienceDto>> queryPowerRecords(@RequestParam("pageNum") Integer pageNum,
                                                        @RequestParam("pageSize") Integer pageSize,
