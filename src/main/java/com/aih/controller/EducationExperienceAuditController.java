...
public class EducationExperienceAuditController {
    ...
    @GetMapping("/query/{id}")
    public R<EducationExperienceDto> queryById(@PathVariable("id") Long id) {
...
//        this.makeFilesUsefulByID(id);
    ...
    public R<Page<EducationExperienceDto>> queryOwnRecord(@RequestParam(value = "auditStatus",required = false) Integer auditStatus,
    ...
    public R<Page<EducationExperienceDto>> queryPowerRecords(@RequestParam("pageNum") Integer pageNum,
                                                             @RequestParam("pageSize") Integer pageSize,
