...
public class HonoraryAwardAuditController {
    ...
    @GetMapping("/query/{id}")
    public R<HonoraryAwardDto> queryById(@PathVariable("id") Long id) {
...
//        this.makeFilesUsefulByID(id);
    ...
    public R<Page<HonoraryAwardDto>> queryOwnRecord(@RequestParam(value = "auditStatus",required = false) Integer auditStatus,
    ...
    public R<Page<HonoraryAwardDto>> queryPowerRecords(@RequestParam("pageNum") Integer pageNum,
                                                             @RequestParam("pageSize") Integer pageSize,
