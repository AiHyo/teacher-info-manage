...
public class ProjectAuditController {
    ...
    @GetMapping("/query/{id}")
    public R<ProjectVo> queryById(@PathVariable("id") Long id) {
...
//        this.makeFilesUsefulByID(id);
    ...
    public R<Page<ProjectVo>> queryOwnRecord(@RequestParam(value = "auditStatus",required = false) Integer auditStatus,
    ...
    public R<Page<ProjectVo>> queryPowerRecords(@RequestParam("pageNum") Integer pageNum,
                                                @RequestParam("pageSize") Integer pageSize,
