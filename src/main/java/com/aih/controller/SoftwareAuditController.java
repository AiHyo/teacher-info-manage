...
public class SoftwareAuditController {
    ...
    @GetMapping("/query/{id}")
    public R<SoftwareDto> queryById(@PathVariable("id") Long id) {
...
//        this.makeFilesUsefulByID(id);
    ...
    public R<Page<SoftwareDto>> queryOwnRecord(@RequestParam(value = "auditStatus",required = false) Integer auditStatus,
    ...
    public R<Page<SoftwareDto>> queryPowerRecords(@RequestParam("pageNum") Integer pageNum,
                                                  @RequestParam("pageSize") Integer pageSize,
